...
// PDF export: captures #results, #health_card, .life-map and downloads A4 PDF
document.getElementById('downloadPdfBtn').addEventListener('click', async () => {
    ...
    try {
        ...
        // тимчасовий контейнер поза екраном
        ...
        // блоки які вставляємо в PDF
        const blocks = [
            document.getElementById("results"),
            document.getElementById("health_card"),
            document.querySelector(".life-map")
        ];
